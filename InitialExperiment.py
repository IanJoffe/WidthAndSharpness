...
if __name__ == "__main__":
    ...
    trained_models, results = run_width_experiment(n=300, d=30, m=np.array([10,15,20]), shuffle_data=True, true_function=xor, convergence_req=1e-2, lr=24.5, batch_size=300, label_noise_dist=torch_binary_label_noise, label_noise_dist_args={"sd":0.005}, max_epochs=2e6)
